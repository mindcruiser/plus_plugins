...
void main() {
  ...
  group('$MethodChannelNetworkInfo', () {
    ...
    test('getWifiGatewayIP', () async {
      ...
      expect(log, <Matcher>[
        isMethodCall('wifiGatewayAddress', arguments: null),
      ]);
    });
