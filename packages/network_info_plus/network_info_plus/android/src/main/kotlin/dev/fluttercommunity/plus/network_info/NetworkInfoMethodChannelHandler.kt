...
/**
 * The handler receives [MethodCall]s from the UIThread, gets the related information from a
 * [NetworkInfo], and then send the result back to the UIThread through the [MethodChannel.Result].
 */
